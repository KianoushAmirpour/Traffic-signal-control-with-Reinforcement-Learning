...
def epsilon_schedule(step):
    progress = (np.clip(step / 540000, a_min=None, a_max=1)) # num of episodes 100 * 5400
    epsilon = 1 - (1 - 0.01) * progress # 1 is the start value for epsilon and 0.01 is the end value for that
    return epsilon
